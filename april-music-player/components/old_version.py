...
class CredentialDialog(QDialog):
    ...
    def generate_credentials(self):
        ...
        self.instruction_label.setText(
            "Open Spotify, go to 'Connect to a device' section, and choose 'Generate Credentials'.")
    ...
    def move_credentials_file(self):
        ...
        try:
            # Move the file
            shutil.move(os.path.join(self.parent.main_script_path, "credentials.json"), self.ej.zotify_credential_path)
